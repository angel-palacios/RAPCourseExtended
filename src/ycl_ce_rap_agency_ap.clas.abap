CLASS ycl_ce_rap_agency_ap DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF y_travel_agency_ap-agencyid.
    TYPES t_business_data TYPE TABLE OF y_travel_agency_ap.
...
CLASS ycl_ce_rap_agency_ap IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA count TYPE int8.
    DATA business_data TYPE TABLE OF y_travel_agency_ap.
    ...
    TRY.
      ...
      CATCH cx_root INTO DATA(lx_exception).
        out->write( cl_message_helper=>get_latest_t100_exception( lx_exception )->if_message~get_text(  ) ).
    ENDTRY.
  ENDMETHOD.
  ...
  METHOD get_agencies.
    ...
    odata_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
     EXPORTING
      iv_service_definition_name = 'YSC_RAP_AGENCY_AP'
